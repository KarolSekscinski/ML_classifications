...
METADATA_URI_FT="gs://$GCS_BUCKET/FinBench/metadata/preprocessing_ft_metadata.json" # Adjust path if different
...
MLP_SCRIPT_PATH="$REPO_PATH/src/gcs/finbench_mlp.py" # Adjust path as needed
FT_SCRIPT_PATH="$REPO_PATH/src/gcs/finbench_ft_transformer.py" # Adjust path as needed
